          ...
          <div className="flex flex-wrap gap-4">
            ...
            >
              ...
              {filteredTodos.length===0 ?(
                <p className="text-center text-gray-500">Aucune tache</p>
              ):(
                filteredTodos.map((todo)=>(
                  <div key={todo.id} className="card bg-base-100 shadow-md">
                    <div className="card-body">
                      <p>{todo.text}</p>
                      <div className={`badge ${todo.priority==="Urigente" ? "badge-error" : todo.priority==="Moyenne" ? "badge-warning" : "badge-success"}`}>
                        {todo.priority}
        </div>
      </div>
    </div>
